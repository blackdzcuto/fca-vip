...
module.exports = function (http, api, ctx) {
  return function changeName(input, format, callback) {
    ...
    var full_name = format == "complete" ? last_name + " " + (middle_name != "" ? middle_name + " " : "") + first_name : format == "standard" ? last_name + " " + first_name : format == "reversed" ? first_name + " " + (middle_name != "" ? middle_name + " " : "") + last_name : last_name + " " + (middle_name != "" ? middle_name + " " : "") + first_name;
    var form = {
    ...
    http.post("https://accountscenter.facebook.com/api/graphql/", ctx.jar, form, null, null, {
