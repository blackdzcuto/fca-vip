...
module.exports = function (http, api, ctx) {
  return function getAccess(authCode = "", callback) {
    ...
    if (!!ctx.access_token) {
      ...
      utils.get(url + "content_management", ctx.jar, null, ctx.globalOptions, null, {
        noRef: true,
        Origin: url
      }).then(function (res) {
        var html = res.body;
        ...
        function submitCode(code) {
          ...
          if (typeof code != "string") {
            ...
            http.post(url + "security/twofactor/reauth/enter/", ctx.jar, {
              approvals_code: code,
              save_device: true,
              lsd
              ...
              return utils.get(url + "content_management", ctx.jar, null, ctx.globalOptions, null, {
                noRef: true
              }).then(function (res) {
                var html = res.body;
